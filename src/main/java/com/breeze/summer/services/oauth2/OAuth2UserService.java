...
import com.breeze.summer.models.AuthProvider;
import com.breeze.summer.dto.auth.User;
import com.breeze.summer.models.auth.oauth2.OAuth2UserInfo;
import com.breeze.summer.models.auth.oauth2.OAuth2UserInfoFactory;
...
public class OAuth2UserService extends DefaultOAuth2UserService {
     ...
     * throw new
     * OAuth2AuthenticationProcessingException("Email not found from OAuth2 provider"
     * );
     * }
     * 
     ...
     * if (!user.getProvider()
     * .equals(AuthProvider.valueOf(oAuth2UserRequest.getClientRegistration().
     * getRegistrationId()))) {
     * throw new
     ...
     * }
     * 
     * // If not, that means he signed up with his email before, so update his
     * account
     * // with oAuth info
     ...
     * }
     * 
     * private User updateExistingUser(User existingUser, OAuth2UserInfo
     * oAuth2UserInfo) {
